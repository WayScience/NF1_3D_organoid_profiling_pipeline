...
1. **Pilot subset selection:** use `NF0014_T1` and `NF0055_T1`, selecting a few DMSO and treated well/FOVs from each to cover normal images, QC failures, segmentation edge cases, image-size variation, and object-count variation.
